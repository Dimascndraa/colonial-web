        ...
        <div class="py-24 max-w-screen-lg mx-auto">
           ...
           <div class="grid grid-cols-3 col-gap-10">
              <div class="text-center bg-white">
                 ...
                 <div class="p-4">
                    <div class="text-md">
                       <a href="#" class="text-2xl hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">Pulkit Handa</a>
              ...
              <div class="text-center bg-white">
                 ...
                 <div class="p-4">
                    <div class="text-md">
                       <a href="#" class="text-2xl hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">John Doe</a>
              ...
              <div class="text-center bg-white">
                 ...
                 <div class="p-4">
                    <div class="text-md">
                       <a href="#" class="text-2xl hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">Sahil Jain</a>
