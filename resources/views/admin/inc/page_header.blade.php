...
<header class="page-header" role="banner">
    ...
    <div class="hidden-md-down dropdown-icon-menu position-relative">
        <a href="/dashboard" class="header-btn btn js-waves-off" data-action="toggle" data-class="nav-function-hidden"
            title="Hide Navigation">
            <i class="ni ni-menu"></i>
        </a>
        <ul>
            <li>
                <a href="/dashboard" class="btn js-waves-off" data-action="toggle" data-class="nav-function-minify"
                    title="Minify Navigation">
                    <i class="ni ni-minify-nav"></i>
                </a>
            </li>
            <li>
                <a href="/dashboard" class="btn js-waves-off" data-action="toggle" data-class="nav-function-fixed"
    ...
    <div class="hidden-lg-up">
        <a href="/dashboard" class="header-btn btn press-scale-down" data-action="toggle" data-class="mobile-nav-on">
            <i class="ni ni-menu"></i>
        </a>
    </div>
    <div class="ml-auto d-flex">
        ...
        <div class="hidden-sm-up">
            <a href="/dashboard" class="header-icon" data-action="toggle" data-class="mobile-search-on"
        ...
        <div class="hidden-md-down">
            <a href="/dashboard" class="header-icon" data-toggle="modal" data-target=".js-modal-settings">
                <i class="fal fa-cog"></i>
            </a>
        </div>
        <!-- app shortcuts -->
        <div>
            <a href="/dashboard" class="header-icon" data-toggle="dropdown" title="My Apps">
            ...
            <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                ...
                <div class="custom-scroll h-100">
                    <ul class="app-list">
                        <li>
                            <a href="/dashboard" class="app-list-item hover-white">
                        ...
                        <li class="w-100">
                            <a href="/dashboard" class="btn btn-default mt-4 mb-2 pr-5 pl-5"> Add more apps </a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <!-- app message -->
        <a href="/dashboard" class="header-icon" data-toggle="modal" data-target=".js-modal-messenger">
            <i class="fal fa-globe"></i>
            <span class="badge badge-icon">!</span>
        </a>
        <!-- app notification -->
        <div>
            <a href="/dashboard" class="header-icon" data-toggle="dropdown" title="You got 11 notifications">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                    ...
                    <div class="tab-pane active p-3 text-center">
                        <h5 class="mt-4 pt-4 fw-500">
                            ...
                            <small class="mt-3 fs-b fw-400 text-muted">
                                ...
                                <a href="/dashboard">settings page</a>
                            </small>
                        </h5>
                    </div>
                                ...
                                <li class="unread">
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="show-on-hover-parent position-absolute pos-right pos-bottom p-3">
                                            <a href="/dashboard" class="text-muted" title="delete"><i
                                        ...
                                        <div class="d-flex flex-column flex-1">
                                            <span class="name">
                                                Adison Lee <span class="fw-300 d-inline">replied to your video <a
                                                        href="/dashboard" class="fw-400"> Cancer Drug</a> </span>
                                            </span>
                ...
                <div
                    ...
                    <a href="/dashboard" class="fs-xs fw-500 ml-auto">view all notifications</a>
                </div>
            </div>
        </div>
        <!-- app user menu -->
        <div>
            <a href="/dashboard" data-toggle="dropdown" title="drlantern@gotbootstrap.com"
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                ...
                <a href="/dashboard" class="dropdown-item" data-action="app-reset">
                    <span data-i18n="drpdwn.reset_layout">Reset Layout</span>
                </a>
                <a href="/dashboard" class="dropdown-item" data-toggle="modal" data-target=".js-modal-settings">
                    <span data-i18n="drpdwn.settings">Settings</span>
                </a>
                <div class="dropdown-divider m-0"></div>
                <a href="/dashboard" class="dropdown-item" data-action="app-fullscreen">
                    <span data-i18n="drpdwn.fullscreen">Fullscreen</span>
                    <i class="float-right text-muted fw-n">F11</i>
                </a>
                <a href="/dashboard" class="dropdown-item" data-action="app-print">
