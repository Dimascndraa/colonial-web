        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="row m-3">
                        <a href="/dashboard/category/create" class="btn btn-lg btn-outline-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="Ubah Kategoru" class="badge mx-1 badge-success p-2 border-0"
                                            href="{{ url('dashboard/category/'.$category->id.'/edit') }}">
                                        ...
                                        <form action="/dashboard/category/{{ $category->id }}" method="POST"
                                            ...
                                            <button title="Hapus" title="Hapus Kategoru"
